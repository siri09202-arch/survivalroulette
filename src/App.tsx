...
const JAPAN_ROADS: JapanRoad[] = [
  { no:1,   from:'東京都中央区日本橋', to:'大阪府大阪市北区梅田・梅田新道交差点' },
  { no:2,   from:'大阪府大阪市北区梅田・梅田新道交差点', to:'福岡県北九州市門司区老松町' },
  { no:3,   from:'福岡県北九州市門司区老松町', to:'鹿児島県鹿児島市照国町・照国神社前' },
  { no:4,   from:'東京都中央区日本橋', to:'青森県青森市長島・青森県庁前' },
  { no:5,   from:'北海道函館市若松町', to:'北海道札幌市中央区北1条西' },
  { no:6,   from:'東京都中央区日本橋', to:'宮城県仙台市宮城野区苦竹' },
  { no:7,   from:'新潟県新潟市中央区本町通七番町', to:'青森県青森市長島' },
  { no:8,   from:'新潟県新潟市中央区本町通七番町', to:'京都府京都市下京区烏丸通七条下ル東塩小路町' },
  { no:9,   from:'京都府京都市下京区烏丸通五条下ル大坂町', to:'山口県下関市細江町' },
  { no:10,  from:'福岡県北九州市門司区老松町', to:'鹿児島県鹿児島市照国町' },
  { no:11,  from:'徳島県徳島市徳島本町', to:'愛媛県松山市二番町' },
  { no:12,  from:'北海道札幌市中央区北1条西', to:'北海道旭川市四条通' },
  { no:13,  from:'福島県福島市舟場町', to:'秋田県秋田市川尻町' },
  { no:14,  from:'東京都中央区日本橋', to:'千葉県千葉市中央区登戸' },
  { no:15,  from:'東京都中央区日本橋', to:'神奈川県横浜市神奈川区青木町' },
  { no:16,  from:'神奈川県横浜市西区桜木町', to:'神奈川県横浜市西区桜木町' },
  { no:17,  from:'東京都中央区日本橋', to:'新潟県新潟市中央区本町通七番町' },
  { no:18,  from:'群馬県高崎市並榎町', to:'新潟県上越市下源入' },
  { no:19,  from:'愛知県名古屋市熱田区金山町', to:'長野県長野市大字西尾張部' },
  { no:20,  from:'東京都中央区日本橋', to:'長野県塩尻市大門泉町' },
  { no:21,  from:'岐阜県瑞浪市土岐町', to:'滋賀県米原市西円寺' },
  { no:22,  from:'愛知県名古屋市熱田区金山町', to:'岐阜県岐阜市茜部本郷' },
  { no:23,  from:'愛知県豊橋市', to:'三重県伊勢市宇治今在家町' },
  { no:24,  from:'京都府京都市下京区烏丸通七条下ル', to:'和歌山県和歌山市小松原通' },
  { no:25,  from:'三重県四日市市塩浜町', to:'大阪府大阪市北区梅田・梅田新道交差点' },
  { no:26,  from:'大阪府大阪市北区梅田・梅田新道交差点', to:'和歌山県和歌山市小松原通・県庁前交差点' },
  { no:27,  from:'福井県敦賀市', to:'京都府船井郡京丹波町蒲生' },
  { no:28,  from:'兵庫県神戸市中央区', to:'徳島県徳島市かちどき橋' },
  { no:29,  from:'兵庫県姫路市本町', to:'鳥取県鳥取市南隈' },
  { no:30,  from:'岡山県岡山市北区大供', to:'香川県高松市番町' },
  { no:31,  from:'広島県安芸郡海田町日の出町', to:'広島県呉市本通' },
  { no:32,  from:'香川県高松市中新町', to:'高知県高知市本町' },
  { no:33,  from:'高知県高知市本町', to:'愛媛県松山市二番町' },
  { no:34,  from:'佐賀県鳥栖市永吉町', to:'長崎県長崎市江戸町' },
  { no:35,  from:'佐賀県武雄市', to:'長崎県佐世保市八幡町' },
  { no:36,  from:'北海道札幌市中央区北1条西', to:'北海道室蘭市東町' },
  { no:37,  from:'北海道山越郡長万部町', to:'北海道室蘭市東町' },
  { no:38,  from:'北海道滝川市新町', to:'北海道釧路市北大通' },
  { no:39,  from:'北海道旭川市四条通', to:'北海道網走市南六条東' },
  { no:40,  from:'北海道旭川市四条通', to:'北海道稚内市中央' },
  { no:41,  from:'愛知県名古屋市東区泉', to:'富山県富山市本町' },
  { no:42,  from:'静岡県浜松市中央区篠原町', to:'和歌山県和歌山市小松原通' },
  { no:43,  from:'大阪府大阪市西成区花園北', to:'兵庫県神戸市灘区岩屋南町' },
  { no:44,  from:'北海道釧路市北大通', to:'北海道根室市常盤町' },
  { no:45,  from:'宮城県仙台市青葉区本町', to:'青森県青森市長島' },
  { no:46,  from:'岩手県盛岡市上田', to:'秋田県秋田市川尻町' },
  { no:47,  from:'宮城県仙台市宮城野区日の出町', to:'山形県酒田市本町' },
  { no:48,  from:'宮城県仙台市青葉区本町', to:'山形県山形市飯田西' },
  { no:49,  from:'福島県いわき市平字十五町目', to:'新潟県新潟市中央区本町通七番町' },
  { no:50,  from:'群馬県前橋市本町', to:'茨城県水戸市三の丸' },
  { no:51,  from:'千葉県千葉市中央区富士見', to:'茨城県水戸市三の丸' },
  { no:52,  from:'静岡県静岡市清水区興津中町', to:'山梨県甲府市丸の内' },
  { no:53,  from:'岡山県岡山市北区大供', to:'鳥取県鳥取市西町' },
  { no:54,  from:'広島県広島市中区大手町', to:'島根県松江市雑賀町' },
  { no:55,  from:'徳島県徳島市かちどき橋', to:'高知県高知市本町' },
  { no:56,  from:'高知県高知市本町', to:'愛媛県松山市二番町' },
  { no:57,  from:'大分県大分市', to:'長崎県長崎市' },
  { no:58,  from:'鹿児島県鹿児島市西千石町', to:'沖縄県那覇市泉崎' },
  { no:101, from:'青森県青森市長島1丁目・青い森公園前交差点', to:'秋田県秋田市山王臨海町・臨海十字路交差点' },
  { no:102, from:'青森県弘前市大字豊田2丁目・運動公園入口交差点', to:'青森県十和田市大字洞内・野崎交差点' },
  { no:103, from:'青森県青森市大字幸畑・国道NTT交差点', to:'秋田県大館市立花・立花交差点' },
  { no:104, from:'青森県八戸市大字長苗代・長苗代二丁目交差点', to:'秋田県大館市立花・立花交差点' },
  { no:105, from:'秋田県由利本荘市水林・水林交差点', to:'秋田県北秋田市栄・大堤交差点' },
  { no:106, from:'岩手県宮古市築地・築地交差点', to:'岩手県盛岡市内丸・市役所前交差点' },
  { no:107, from:'岩手県大船渡市盛町・権現堂交差点', to:'秋田県由利本荘市水林・水林交差点' },
  { no:108, from:'宮城県石巻市丸井戸・丸井戸交差点', to:'秋田県由利本荘市水林・水林交差点' },
  { no:112, from:'山形県山形市飯田西・飯田交差点', to:'山形県酒田市本町・本町交差点' },
  { no:113, from:'新潟県新潟市中央区本町通7番町・本町交差点', to:'福島県相馬市中村・大曲交差点' },
  { no:114, from:'福島県福島市仲間町・仲間町交差点', to:'福島県双葉郡浪江町大字権現堂・知命寺交差点' },
  { no:115, from:'福島県相馬市中村・大曲交差点', to:'福島県耶麻郡猪苗代町字堅田・堅田中丸交差点' },
  { no:116, from:'新潟県柏崎市柳橋町・柳橋町交差点', to:'新潟県新潟市中央区本町通7番町・本町交差点' },
  { no:117, from:'長野県長野市大字中御所・中御所交差点', to:'新潟県小千谷市東栄・東栄交差点' },
  { no:118, from:'茨城県水戸市三の丸1丁目・中央郵便局前交差点', to:'福島県会津若松市町北町大字始・北柳原交差点' },
  { no:119, from:'栃木県日光市山内・神橋交差点', to:'栃木県宇都宮市池上町・池上町交差点' },
  { no:120, from:'栃木県日光市細尾町・細尾大谷橋交差点', to:'群馬県沼田市下川田町・下川田町交差点' },
  { no:121, from:'山形県米沢市丸の内1丁目・松ヶ岬交差点', to:'栃木県芳賀郡益子町大字益子・七井中央交差点' },
  { no:122, from:'栃木県日光市細尾町・細尾大谷橋交差点', to:'東京都豊島区南長崎6丁目・千川通り交差点' },
  { no:123, from:'栃木県宇都宮市平松町・平松町交差点', to:'茨城県水戸市三の丸1丁目・中央郵便局前交差点' },
  { no:124, from:'千葉県銚子市大橋町・銚子大橋前交差点', to:'茨城県水戸市三の丸1丁目・三の丸1丁目交差点' },
  { no:125, from:'茨城県香取市佐原・佐原駅入口交差点', to:'埼玉県熊谷市上之・上之南交差点' },
  { no:126, from:'千葉県銚子市大橋町・銚子大橋前交差点', to:'千葉県千葉市稲毛区園生町・穴川インター交差点' },
  { no:127, from:'千葉県館山市北条・南総文化ホール前交差点', to:'千葉県木更津市桜井・桜井交差点' },
  { no:128, from:'千葉県館山市北条・北条交差点', to:'千葉県千葉市中央区本町1丁目・広小路交差点' },
  { no:129, from:'神奈川県平塚市高浜台・高浜台交差点', to:'神奈川県相模原市緑区橋本・橋本五差路交差点' },
  { no:130, from:'東京都港区海岸3丁目・東京港', to:'東京都港区芝4丁目・芝4丁目交差点' },
  { no:131, from:'東京都大田区羽田空港3丁目・穴守橋東詰交差点', to:'東京都大田区大森東2丁目・大森警察署前交差点' },
  { no:132, from:'神奈川県川崎市川崎区東扇島・川崎港', to:'神奈川県川崎市川崎区宮前町・宮前町交差点' },
  { no:133, from:'神奈川県横浜市中区海岸通・横浜港', to:'神奈川県横浜市中区桜木町1丁目・桜木町1交差点' },
  { no:134, from:'神奈川県横須賀市三春町2丁目・三春町2交差点', to:'神奈川県中郡大磯町大磯・大磯駅入口交差点' },
  { no:135, from:'静岡県下田市三丁目・中島橋交差点', to:'神奈川県小田原市早川1丁目・早川口交差点' },
  { no:136, from:'静岡県下田市三丁目・中島橋交差点', to:'静岡県三島市南二日町・南二日町IC' },
  { no:137, from:'山梨県富士吉田市上吉田・上宿交差点', to:'山梨県笛吹市石和町四日市場・四日市場交差点' },
  { no:138, from:'山梨県富士吉田市上吉田・上宿交差点', to:'神奈川県小田原市本町1丁目・小田原市民会館前交差点' },
  { no:139, from:'静岡県富士市青島町・青島交差点', to:'東京都西多摩郡奥多摩町原・深山橋交差点' },
  { no:140, from:'埼玉県熊谷市本石2丁目・本石2丁目交差点', to:'山梨県南巨摩郡富士川町青柳町・青柳交差点' },
  { no:141, from:'山梨県韮崎市本町2丁目・韮崎駅入口交差点', to:'長野県上田市中央2丁目・中央北交差点' },
  { no:142, from:'長野県北佐久郡軽井沢町軽井沢・軽井沢駅入口交差点', to:'長野県諏訪郡下諏訪町東赤砂・大社通り交差点' },
  { no:143, from:'長野県松本市中央1丁目・渚1丁目交差点', to:'長野県上田市中央2丁目・中央北交差点' },
  { no:144, from:'群馬県吾妻郡長野原町大字長野原・羽根尾交差点', to:'長野県上田市中央2丁目・中央北交差点' },
  { no:145, from:'群馬県吾妻郡長野原町大字長野原・羽根尾交差点', to:'群馬県沼田市下川田町・下川田町交差点' },
  { no:146, from:'群馬県吾妻郡長野原町大字長野原・羽根尾交差点', to:'長野県北佐久郡軽井沢町大字長倉・峰の茶屋交差点' },
  { no:147, from:'長野県大町市大町・大町駅入口交差点', to:'長野県松本市渚1丁目・渚1丁目交差点' },
  { no:148, from:'長野県大町市大町・大町駅入口交差点', to:'新潟県糸魚川市大町・大町交差点' },
  { no:149, from:'静岡県静岡市清水区日の出町・清水港', to:'静岡県静岡市清水区大和町・大和町交差点' },
  { no:150, from:'静岡県静岡市清水区興津中町・興津中町交差点', to:'静岡県浜松市中央区篠原町・篠原交差点' },
  { no:151, from:'長野県飯田市中央通り4丁目・中央通り4丁目交差点', to:'愛知県豊橋市東八町・東八町交差点' },
  { no:152, from:'長野県上田市中央2丁目・中央北交差点', to:'静岡県浜松市中央区相生町・相生町交差点' },
  { no:153, from:'愛知県名古屋市東区泉2丁目・高岳交差点', to:'長野県塩尻市大門泉町・高出交差点' },
  { no:154, from:'愛知県名古屋市港区港栄2丁目・名古屋港', to:'愛知県名古屋市熱田区神宮3丁目・熱田神宮南交差点' },
  { no:155, from:'愛知県常滑市原松町・原松町交差点', to:'愛知県弥富市稲荷1丁目・稲荷交差点' },
  { no:156, from:'岐阜県岐阜市茜部本郷1丁目・茜部本郷交差点', to:'富山県高岡市四屋・四屋交差点' },
  { no:157, from:'石川県金沢市野町1丁目・野町広小路交差点', to:'岐阜県岐阜市茜部本郷1丁目・茜部本郷交差点' },
  { no:158, from:'福井県福井市新保1丁目・新保交差点', to:'長野県松本市島立・松本インター入口交差点' },
  { no:159, from:'石川県七尾市川原町・川原町交差点', to:'石川県金沢市武蔵町・武蔵交差点' },
  { no:160, from:'石川県七尾市川原町・川原町交差点', to:'富山県高岡市四屋・四屋交差点' },
  { no:161, from:'福井県敦賀市疋田・疋田交差点', to:'滋賀県大津市逢坂1丁目・逢坂1丁目交差点' },
  { no:162, from:'京都府京都市右京区梅ケ畑・福王子交差点', to:'福井県敦賀市岡山町2丁目・岡山町交差点' },
  { no:163, from:'大阪府大阪市北区梅田1丁目・梅田新道交差点', to:'三重県津市東丸之内・岩田橋交差点' },
  { no:164, from:'三重県四日市市千歳町・四日市港', to:'三重県津市栄町3丁目・栄町交差点' },
  { no:165, from:'大阪府大阪市北区梅田1丁目・梅田新道交差点', to:'三重県津市雲出本郷町・雲出本郷交差点' },
  { no:166, from:'大阪府羽曳野市誉田6丁目・白鳥交差点', to:'三重県松阪市大黒田町・大黒田町交差点' },
  { no:167, from:'三重県志摩市阿児町鵜方・鵜方駅西口交差点', to:'三重県伊勢市宇治今在家町・猿田彦神社前交差点' },
  { no:168, from:'和歌山県新宮市徐福2丁目・新宮駅前交差点', to:'大阪府枚方市天之川町・天之川交差点' },
  { no:169, from:'奈良県奈良市三条大路3丁目・三条大路3丁目交差点', to:'和歌山県新宮市徐福2丁目・新宮駅前交差点' },
  { no:170, from:'大阪府高槻市八丁畷町・八丁畷交差点', to:'大阪府泉佐野市上瓦屋・上瓦屋交差点' },
  { no:171, from:'京都府京都市南区東九条西山王町・九条油小路交差点', to:'兵庫県神戸市中央区生田町1丁目・生田川交差点' },
  { no:172, from:'大阪府大阪市港区築港3丁目・大阪港', to:'大阪府大阪市中央区本町3丁目・本町3丁目交差点' },
  { no:173, from:'大阪府池田市新町・新町交差点', to:'京都府綾部市大島町・大島交差点' },
  { no:174, from:'兵庫県神戸市中央区新港町・神戸港', to:'兵庫県神戸市中央区浜辺通5丁目・税関前交差点' },
  { no:175, from:'兵庫県明石市和坂・和坂交差点', to:'京都府舞鶴市字魚屋・大手交差点' },
  { no:176, from:'京都府宮津市新浜・新浜交差点', to:'大阪府大阪市北区梅田1丁目・梅田新道交差点' },
  { no:177, from:'京都府舞鶴市字浜・舞鶴港', to:'京都府舞鶴市字魚屋・大手交差点' },
  { no:178, from:'京都府舞鶴市字魚屋・大手交差点', to:'鳥取県岩美郡岩美町大字浦富・浦富交差点' },
  { no:179, from:'兵庫県姫路市青山3丁目・青山西交差点', to:'鳥取県東伯郡湯梨浜町大字長和田・長和田交差点' },
  { no:180, from:'岡山県岡山市北区大供1丁目・大供交差点', to:'島根県松江市雑賀町・相生町交差点' },
  { no:181, from:'岡山県津山市昭和町2丁目・津山駅前交差点', to:'鳥取県米子市公会堂前・公会堂前交差点' },
  { no:182, from:'岡山県新見市新見・新見交差点', to:'広島県福山市明神町2丁目・明神町交差点' },
  { no:183, from:'広島県広島市中区基町・基町交差点', to:'鳥取県米子市公会堂前・公会堂前交差点' },
  { no:184, from:'島根県出雲市今市町・今市町交差点', to:'広島県尾道市東御所町・尾道駅前交差点' },
  { no:185, from:'広島県呉市本通1丁目・本通1丁目交差点', to:'広島県三原市糸崎8丁目・糸崎8丁目交差点' },
  { no:186, from:'島根県江津市渡津町・渡津交差点', to:'広島県大竹市小方1丁目・小方交差点' },
  { no:187, from:'山口県岩国市麻里布町2丁目・麻里布町2丁目交差点', to:'島根県益田市中吉田町・中吉田交差点' },
  { no:188, from:'山口県岩国市麻里布町2丁目・麻里布町2丁目交差点', to:'山口県下松市望町4丁目・望町交差点' },
  { no:189, from:'山口県岩国市旭町2丁目・岩国空港', to:'山口県岩国市麻里布町1丁目・麻里布町1丁目交差点' },
  { no:190, from:'山口県山口市小郡下郷・新山口駅前交差点', to:'山口県山陽小野田市西高泊・西高泊交差点' },
  { no:191, from:'山口県下関市竹崎町3丁目・竹崎町交差点', to:'広島県広島市中区基町・基町交差点' },
  { no:192, from:'愛媛県西条市大町・大町交差点', to:'徳島県徳島市徳島本町2丁目・徳島本町交差点' },
  { no:193, from:'香川県高松市中新町・中新町交差点', to:'徳島県海部郡海陽町宍喰浦・宍喰交差点' },
  { no:194, from:'高知県高知市本町5丁目・県庁前交差点', to:'愛媛県西条市大町・大町交差点' },
  { no:195, from:'高知県高知市本町5丁目・県庁前交差点', to:'徳島県徳島市徳島本町2丁目・徳島本町交差点' },
  { no:196, from:'愛媛県松山市二番町4丁目・市役所前交差点', to:'愛媛県西条市大町・大町交差点' },
  { no:197, from:'高知県高知市本町5丁目・県庁前交差点', to:'大分県大分市長浜町2丁目・長浜町交差点' },
  { no:198, from:'福岡県北九州市門司区港町・門司港', to:'福岡県北九州市門司区桟橋通・桟橋通交差点' },
  { no:199, from:'福岡県北九州市門司区西海岸1丁目・門司港', to:'福岡県北九州市八幡西区則松5丁目・則松交差点' },
  { no:200, from:'福岡県北九州市八幡西区黒崎3丁目・黒崎駅前', to:'福岡県筑紫野市二日市中央・原田交差点' },
  { no:201, from:'福岡県福岡市東区香椎・香椎交差点', to:'大分県日田市南元町・南元町交差点' },
  { no:202, from:'福岡県福岡市博多区千代1丁目・千代交差点', to:'長崎県長崎市江戸町・江戸町交差点' },
  { no:203, from:'佐賀県唐津市新興町・唐津駅前', to:'佐賀県佐賀市神野東・神野東交差点' },
  { no:204, from:'佐賀県唐津市東城内・東城内交差点', to:'長崎県佐世保市八幡町・八幡町交差点' },
  { no:205, from:'長崎県佐世保市早岐1丁目・早岐駅前', to:'長崎県東彼杵郡東彼杵町蔵本郷・彼杵交差点' },
  { no:206, from:'長崎県長崎市宝町・宝町交差点', to:'長崎県佐世保市八幡町・八幡町交差点' },
  { no:207, from:'佐賀県佐賀市神野東・神野東交差点', to:'長崎県西彼杵郡時津町元村郷・元村交差点' },
  { no:208, from:'熊本県熊本市中央区水道町・水道町交差点', to:'佐賀県佐賀市日の出1丁目・日の出交差点' },
  { no:209, from:'福岡県大牟田市有明町2丁目・有明町交差点', to:'福岡県久留米市東町・東町交差点' },
  { no:210, from:'福岡県久留米市東町・東町交差点', to:'大分県大分市府内町1丁目・府内町交差点' },
  { no:211, from:'大分県日田市南元町・南元町交差点', to:'福岡県北九州市八幡西区引野1丁目・引野口交差点' },
  { no:212, from:'大分県中津市豊田町・豊田町交差点', to:'熊本県阿蘇市黒川・内牧温泉入口交差点' },
  { no:213, from:'大分県別府市北浜2丁目・北浜交差点', to:'大分県中津市豊田町・豊田町交差点' },
  { no:217, from:'大分県大分市大道町・大道入口交差点', to:'大分県佐伯市弥生大字小田・番匠交差点' },
  { no:218, from:'熊本県熊本市中央区迎町・代継橋交差点', to:'宮崎県延岡市昭和町・昭和町交差点' },
  { no:219, from:'熊本県熊本市中央区水道町・水道町交差点', to:'宮崎県宮崎市橘通東・橘通3丁目交差点' },
  { no:220, from:'宮崎県宮崎市橘通東・橘通3丁目交差点', to:'鹿児島県霧島市国分敷根・国分敷根交差点' },
  { no:221, from:'熊本県人吉市東間下町・東間下町交差点', to:'宮崎県都城市松之元町・松之元交差点' },
  { no:222, from:'宮崎県日南市中央通・中央通1丁目交差点', to:'宮崎県都城市大王町・大王交差点' },
  { no:223, from:'宮崎県小林市細野・東上町交差点', to:'鹿児島県霧島市国分下井・国道223入口交差点' },
  { no:224, from:'鹿児島県垂水市海潟・桜島口交差点', to:'鹿児島県鹿児島市山下町・中央公民館前交差点' },
  { no:225, from:'鹿児島県枕崎市千代田町・町頭交差点', to:'鹿児島県鹿児島市照国町・照国神社前交差点' },
  { no:226, from:'鹿児島県南さつま市加世田本町・本町交差点', to:'鹿児島県鹿児島市照国町・照国神社前交差点' },
  { no:227, from:'北海道函館市万代町・万代跨線橋交差点', to:'北海道檜山郡江差町字中歌町・中村家前交差点' },
  { no:228, from:'北海道函館市万代町・万代跨線橋交差点', to:'北海道檜山郡江差町字中歌町・中村家前交差点' },
  { no:229, from:'北海道小樽市稲穂1丁目・稲穂1-8交差点', to:'北海道檜山郡江差町・国道227号交差点' },
  { no:230, from:'北海道札幌市中央区北1条西・北1西2交差点', to:'北海道久遠郡せたな町北檜山区北檜山・北檜山交差点' },
  { no:231, from:'北海道札幌市北区北34条西・北34西2交差点', to:'北海道留萌市元川町・元川町2交差点' },
  { no:232, from:'北海道稚内市中央・中央2交差点', to:'北海道留萌市元川町・元川町1交差点' },
  { no:233, from:'北海道旭川市四条通・4条通8丁目交差点', to:'北海道留萌市元川町・元川町1交差点' },
  { no:234, from:'北海道岩見沢市四条西・4条西1丁目交差点', to:'北海道苫小牧市若草町・若草町交差点' },
  { no:235, from:'北海道室蘭市海岸町・海岸通交差点', to:'北海道浦河郡浦河町大通・大通2交差点' },
  { no:236, from:'北海道帯広市大通北・大通北1交差点', to:'北海道浦河郡浦河町大通・大通2交差点' },
  { no:237, from:'北海道旭川市四条通・4条通8丁目交差点', to:'北海道浦河郡浦河町大通・大通2交差点' },
  { no:238, from:'北海道網走市大曲・大曲1交差点', to:'北海道稚内市潮見・潮見4交差点' },
  { no:239, from:'北海道網走市大曲・大曲1交差点', to:'北海道留萌市元川町・元川町1交差点' },
  { no:240, from:'北海道釧路市大楽毛・大楽毛交差点', to:'北海道網走市南4条西・南4西1交差点' },
  { no:241, from:'北海道川上郡弟子屈町中央・中央交差点', to:'北海道帯広市大通南・大通北1交差点' },
  { no:242, from:'北海道網走市南4条西・南4西1交差点', to:'北海道帯広市大通北・大通北1交差点' },
  { no:243, from:'北海道網走市南4条西・南4西1交差点', to:'北海道根室市厚床・厚床1交差点' },
  { no:244, from:'北海道網走市南4条西・南4西1交差点', to:'北海道根室市厚床・厚床1交差点' },
  { no:245, from:'茨城県水戸市三の丸・三の丸1丁目交差点', to:'茨城県日立市留町・留町交差点' },
  { no:246, from:'東京都千代田区永田町・三宅坂交差点', to:'静岡県沼津市大手町・大手町交差点' },
  { no:247, from:'愛知県名古屋市熱田区神宮・熱田神宮南交差点', to:'愛知県豊橋市東八町・西八町交差点' },
  { no:248, from:'愛知県蒲郡市競艇場町・競艇場西交差点', to:'岐阜県岐阜市茜部本郷・茜部本郷交差点' },
  { no:249, from:'石川県七尾市川原町・川原町交差点', to:'石川県金沢市武蔵町・むさし交差点' },
  { no:250, from:'兵庫県神戸市長田区東尻池新町・東尻池交差点', to:'岡山県岡山市北区大雲寺町・大雲寺交差点' },
  { no:251, from:'長崎県長崎市江戸町・江戸町交差点', to:'長崎県諫早市小船越町・小船越交差点' },
  { no:252, from:'新潟県柏崎市日吉町・日吉町交差点', to:'福島県会津若松市神明通り・神明通り北交差点' },
  { no:253, from:'新潟県上越市三ツ屋町・三ツ屋交差点', to:'新潟県南魚沼市美佐島・美佐島交差点' },
  { no:254, from:'東京都文京区本郷・本郷3丁目交差点', to:'長野県松本市島立・平瀬口交差点' },
  { no:255, from:'神奈川県秦野市新町・新町交差点', to:'神奈川県小田原市本町・小田原市民会館前交差点' },
  { no:256, from:'岐阜県岐阜市茜部本郷・茜部本郷交差点', to:'長野県飯田市中央通り・中央通り3丁目交差点' },
  { no:257, from:'静岡県浜松市中央区篠原町・篠原交差点', to:'岐阜県高山市上岡本町・上岡本町南交差点' },
  { no:258, from:'岐阜県大垣市楽田町・楽田町交差点', to:'三重県桑名市大字小貝須・小貝須交差点' },
  { no:259, from:'三重県鳥羽市鳥羽・鳥羽駅前交差点', to:'愛知県豊橋市東八町・西八町交差点' },
  { no:260, from:'三重県志摩市阿児町神明・賢島駅前交差点', to:'三重県北牟婁郡紀北町東長島・片上南交差点' },
  { no:261, from:'広島県広島市中区大手町・広島市役所前交差点', to:'島根県江津市渡津町・渡津交差点' },
  { no:262, from:'山口県萩市土原・土原交差点', to:'山口県防府市佐波・佐波交差点' },
  { no:263, from:'福岡県福岡市早良区荒江・荒江交差点', to:'佐賀県佐賀市日の出・SAGAアリーナ前交差点' },
  { no:264, from:'佐賀県佐賀市日の出・SAGAアリーナ前交差点', to:'福岡県久留米市日吉町・六ツ門交差点' },
  { no:265, from:'宮崎県小林市本町・本町交差点', to:'熊本県阿蘇市内牧・内牧温泉入口交差点' },
  { no:266, from:'熊本県天草市牛深町・牛深港交差点', to:'熊本県熊本市中央区迎町・代継橋交差点' },
  { no:267, from:'熊本県人吉市西間上町・西間上町交差点', to:'鹿児島県薩摩川内市大小路町・国道267号入口交差点' },
  { no:268, from:'熊本県水俣市・水俣IC入口交差点', to:'宮崎県宮崎市赤谷・赤谷交差点' },
  { no:269, from:'鹿児島県指宿市十二町・国立病院前交差点', to:'宮崎県宮崎市橘通東・橘通3丁目交差点' },
  { no:270, from:'鹿児島県枕崎市千代田町・町頭交差点', to:'鹿児島県いちき串木野市大原町・大原交差点' },
  { no:271, from:'神奈川県小田原市早川・小田原西IC', to:'神奈川県厚木市船子・厚木IC' },
  { no:272, from:'北海道釧路市幣舞町・幣舞ロータリー', to:'北海道標津郡標津町南7条西・南7東1交差点' },
  { no:273, from:'北海道帯広市大通北・大通北1交差点', to:'北海道紋別市本町・本町交差点' },
  { no:274, from:'北海道札幌市北区北34条西・北34西2／北33西1交差点', to:'北海道川上郡標茶町川上・川上2交差点' },
  { no:275, from:'北海道札幌市中央区北1条東・北1東14交差点', to:'北海道枝幸郡浜頓別町・国道238号交差点' },
  { no:276, from:'北海道檜山郡江差町・中村家前交差点', to:'北海道苫小牧市若草町・若草町交差点' },
  { no:277, from:'北海道檜山郡江差町・中村家前交差点', to:'北海道二海郡八雲町本町・本町交差点' },
  { no:278, from:'北海道函館市若松町・函館駅前交差点', to:'北海道茅部郡森町・国道5号交差点' },
  { no:279, from:'北海道函館市若松町・函館駅前交差点', to:'青森県上北郡野辺地町・松ノ木平交差点' },
  { no:280, from:'青森県青森市古川・上古川交差点', to:'北海道函館市万代町・万代跨線橋交差点' },
  { no:281, from:'岩手県盛岡市内丸・NHK前交差点', to:'岩手県久慈市長内町・長内トンネル北口交差点' },
  { no:282, from:'岩手県盛岡市内丸・NHK前交差点', to:'青森県平川市碇ヶ関・碇ヶ関交差点' },
  { no:283, from:'岩手県釜石市只越町・只越町交差点', to:'岩手県花巻市城内・花巻市役所前交差点' },
  { no:284, from:'岩手県陸前高田市高田町・高田交差点', to:'岩手県一関市大町・大町交差点' },
  { no:285, from:'秋田県秋田市川尻町・川尻若葉町交差点', to:'秋田県鹿角市花輪・花輪交差点' },
  { no:286, from:'宮城県仙台市太白区長町・長町交差点', to:'山形県山形市飯田西・飯田交差点' },
  { no:287, from:'山形県米沢市金池・金池交差点', to:'山形県東根市蟹沢・蟹沢交差点' },
  { no:288, from:'福島県郡山市・国道4号交差点', to:'福島県双葉郡双葉町・牛踏交差点' },
  { no:289, from:'新潟県新潟市中央区本町通・本町交差点', to:'福島県いわき市・鶴ヶ町IC' },
  { no:290, from:'新潟県村上市石原・石原交差点', to:'新潟県魚沼市四日町・四日町交差点' },
  { no:291, from:'群馬県前橋市本町・本町1交差点', to:'新潟県柏崎市日吉町・日吉町交差点' },
  { no:292, from:'群馬県吾妻郡長野原町大字長野原・羽根尾交差点', to:'新潟県妙高市関川・関川交差点' },
  { no:293, from:'茨城県日立市留町・留町交差点', to:'栃木県足利市問屋町・卸売市場前交差点' },
  { no:294, from:'千葉県柏市呼塚・呼塚交差点', to:'福島県会津若松市町北町・北柳原交差点' },
  { no:295, from:'千葉県成田市取香・成田国際空港', to:'千葉県成田市不動ヶ岡・不動ヶ岡交差点' },
  { no:296, from:'千葉県匝瑳市・国道126号交差点', to:'千葉県船橋市宮本・宮本交差点' },
  { no:297, from:'千葉県館山市北条・北条交差点', to:'千葉県市原市五井中央西・市原埠頭入口交差点' },
  { no:298, from:'埼玉県和光市新倉・松ノ木島交差点', to:'千葉県市川市高谷・高谷JCT付近' },
  { no:299, from:'長野県茅野市宮川・新井交差点', to:'埼玉県入間市河原町・河原町交差点' },
  { no:300, from:'山梨県富士吉田市上吉田・上宿交差点', to:'山梨県南巨摩郡身延町・上沢交差点' },
  { no:301, from:'静岡県浜松市中央区篠原町・篠原交差点', to:'愛知県豊田市挙母町・挙母町1交差点' },
  { no:302, from:'愛知県名古屋市中川区富田町・供米田交差点', to:'愛知県名古屋市中川区富田町・供米田交差点' },
  { no:303, from:'岐阜県岐阜市茜部本郷・茜部本郷交差点', to:'福井県三方上中郡若狭町三宅・三宅交差点' },
  { no:304, from:'石川県金沢市今町・今町JCT付近', to:'富山県南砺市城端・城端交差点' },
  { no:305, from:'石川県金沢市・武蔵交差点', to:'福井県南条郡南越前町今庄・今庄交差点' },
  { no:306, from:'滋賀県彦根市外町・外町交差点', to:'三重県津市垂水・垂水交差点' },
  { no:307, from:'滋賀県彦根市外町・外町交差点', to:'大阪府枚方市池之宮・池之宮北交差点' },
  { no:308, from:'大阪府大阪市中央区西心斎橋・新橋交差点', to:'奈良県奈良市三条大路・三条大路2交差点' },
  { no:309, from:'三重県熊野市五郷町小阪・小阪交差点', to:'大阪府大阪市平野区平野馬場・平野馬場交差点' },
  { no:310, from:'大阪府堺市堺区翁橋町・安井町交差点', to:'奈良県五條市本町・本陣交差点' },
  { no:311, from:'三重県尾鷲市矢浜・新矢ノ川橋西交差点', to:'和歌山県西牟婁郡上富田町朝来・岩崎交差点' },
  { no:312, from:'京都府宮津市字新浜・新大手橋交差点', to:'兵庫県姫路市・姫路東ランプ' },
  { no:313, from:'広島県福山市府中町・府中分かれ交差点', to:'鳥取県東伯郡北栄町由良宿・北条交差点' },
  { no:314, from:'広島県福山市明神町・明神町交差点', to:'島根県雲南市三刀屋町・下熊谷交差点' },
  { no:315, from:'山口県周南市徳山・三田川交差点', to:'山口県萩市椿東・津田交差点' },
  { no:316, from:'山口県長門市東深川・正明市交差点', to:'山口県山陽小野田市西高泊・西高泊交差点' },
  { no:317, from:'愛媛県松山市二番町・市役所前交差点', to:'広島県尾道市東御所町・尾道駅前交差点' },
  { no:318, from:'徳島県徳島市徳島本町・徳島本町交差点', to:'香川県東かがわ市・田高田交差点' },
  { no:319, from:'香川県坂出市川津町・川津交差点', to:'愛媛県四国中央市三島中央・三島金子交差点' },
  { no:320, from:'高知県宿毛市・国道56号交差点', to:'愛媛県北宇和郡鬼北町近永・国道197号交差点' },
  { no:321, from:'高知県四万十市中村・中村駅前交差点', to:'高知県宿毛市中央・中央2丁目交差点' },
  { no:322, from:'福岡県北九州市小倉北区・三萩野交差点', to:'熊本県山鹿市・山鹿市役所前交差点' },
  { no:323, from:'佐賀県佐賀市日の出・SAGAアリーナ前交差点', to:'佐賀県唐津市浜玉町・浜交差点' },
  { no:324, from:'長崎県長崎市江戸町・江戸町交差点', to:'熊本県宇城市三角町・五橋入口交差点' },
  { no:325, from:'福岡県久留米市東町・東町交差点', to:'宮崎県西臼杵郡高千穂町・総合運動公園前交差点' },
  { no:326, from:'宮崎県延岡市昭和町・昭和町交差点', to:'大分県豊後大野市三重町・三重町交差点' },
  { no:327, from:'宮崎県日向市鶴町・鶴町交差点', to:'熊本県上益城郡山都町・国道218号交差点' },
  { no:328, from:'鹿児島県鹿児島市小山田町・小山田町交差点', to:'鹿児島県出水市昭和町・出水IC入口交差点' },
  { no:329, from:'沖縄県名護市世冨慶・世冨慶交差点', to:'沖縄県那覇市楚辺・明治橋交差点' },
  { no:330, from:'沖縄県沖縄市照屋1丁目・コザ十字路交差点', to:'沖縄県那覇市旭町・旭橋交差点' },
  { no:331, from:'沖縄県那覇市通堂町・明治橋交差点', to:'沖縄県国頭郡大宜味村塩屋' },
  { no:332, from:'沖縄県那覇市・那覇空港', to:'沖縄県那覇市通堂町・明治橋交差点' },
  { no:333, from:'北海道旭川市・4条通8丁目交差点', to:'北海道北見市端野町・端野町交差点' },
  { no:334, from:'北海道目梨郡羅臼町・羅臼町本町交差点', to:'北海道網走郡美幌町・報徳交差点' },
  { no:335, from:'北海道目梨郡羅臼町・羅臼町本町交差点', to:'北海道標津郡標津町・忠類交差点' },
  { no:336, from:'北海道浦河郡浦河町・大通2丁目交差点', to:'北海道釧路市・幣舞ロータリー' },
  { no:337, from:'北海道千歳市・錦町2丁目交差点', to:'北海道小樽市・銭函' },
  { no:338, from:'北海道函館市・函館駅前', to:'青森県上北郡おいらせ町・苗振谷地交差点' },
  { no:339, from:'青森県弘前市・運動公園入口交差点', to:'青森県東津軽郡外ヶ浜町・三厩' },
  { no:340, from:'岩手県陸前高田市・気仙大橋西交差点', to:'青森県八戸市・塩町交差点' },
  { no:341, from:'秋田県鹿角市・長嶺交差点', to:'秋田県由利本荘市・水林交差点' },
  { no:342, from:'秋田県横手市・安田交差点', to:'宮城県登米市・柳津' },
  { no:343, from:'岩手県陸前高田市・気仙大橋西交差点', to:'岩手県奥州市・中田町交差点' },
  { no:344, from:'秋田県湯沢市・湯沢駅前交差点', to:'山形県酒田市・上安町交差点' },
  { no:345, from:'新潟県新潟市中央区・東港線十字路交差点', to:'山形県飽海郡遊佐町・女鹿交差点' },
  { no:346, from:'宮城県仙台市青葉区', to:'宮城県気仙沼市・松川IC交差点' },
  { no:347, from:'山形県寒河江市・高松交差点', to:'宮城県大崎市・城西交差点' },
  { no:348, from:'山形県長井市・今泉交差点', to:'山形県山形市・鉄砲町2丁目交差点' },
  { no:349, from:'茨城県水戸市・大町3丁目交差点', to:'宮城県柴田郡柴田町・槻木交差点' },
  { no:350, from:'新潟県新潟市中央区・本町交差点', to:'新潟県上越市・下源入交差点' },
  { no:351, from:'新潟県長岡市・宮沢橋西詰交差点', to:'新潟県小千谷市・木津交差点' },
  { no:352, from:'新潟県柏崎市・柳橋町交差点', to:'栃木県河内郡上三川町・上三川交差点' },
  { no:353, from:'群馬県桐生市・広沢町4丁目交差点', to:'新潟県柏崎市・枇杷島交差点' },
  { no:354, from:'群馬県高崎市・君が代橋交差点', to:'茨城県鉾田市・大洋総合支所入口交差点' },
  { no:355, from:'千葉県香取市・佐原跨道橋交差点', to:'茨城県笠間市・寺崎交差点' },
  { no:356, from:'千葉県銚子市・銚子大橋前交差点', to:'千葉県我孫子市・根戸交差点' },
  { no:357, from:'千葉県千葉市中央区・村田町交差点', to:'神奈川県横須賀市・東京湾岸道路終点' },
  { no:358, from:'山梨県南都留郡富士河口湖町・赤池交差点', to:'山梨県甲府市・甲府署前交差点' },
  { no:359, from:'富山県富山市・掛尾町交差点', to:'石川県金沢市・橋場交差点' },
  { no:360, from:'富山県富山市・城址公園前交差点', to:'石川県小松市・空港西口交差点' },
  { no:361, from:'岐阜県高山市・松之木町交差点', to:'長野県伊那市・高遠公園下交差点' },
  { no:362, from:'愛知県豊川市・馬場町交差点', to:'静岡県静岡市葵区・常磐町2丁目交差点' },
  { no:363, from:'愛知県名古屋市名東区・引山交差点', to:'岐阜県中津川市・中村交差点' },
  { no:364, from:'福井県大野市・エキサイト広場南東交差点', to:'石川県加賀市・黒瀬交差点' },
  { no:365, from:'石川県加賀市・黒瀬交差点', to:'三重県四日市市・四日市橋南詰交差点' },
  { no:366, from:'愛知県半田市・祢宜町交差点', to:'愛知県名古屋市緑区・有松IC' },
  { no:367, from:'京都府京都市下京区・烏丸五条交差点', to:'福井県三方上中郡若狭町・三宅交差点' },
  { no:368, from:'三重県伊賀市・八幡交差点', to:'三重県多気郡多気町・丹生交差点' },
  { no:369, from:'奈良県奈良市・二条大路南1丁目交差点', to:'三重県松阪市・大黒田西交差点' },
  { no:370, from:'和歌山県海南市・船尾東交差点', to:'奈良県奈良市・針インター北交差点' },
  { no:371, from:'大阪府河内長野市・本町交差点', to:'和歌山県東牟婁郡串本町・高富交差点' },
  { no:372, from:'京都府亀岡市・加塚交差点', to:'兵庫県姫路市・下寺町交差点' },
  { no:373, from:'兵庫県赤穂市・有年原交差点', to:'鳥取県鳥取市・秋里交差点' },
  { no:374, from:'岡山県備前市・伊部東交差点', to:'岡山県津山市・新河辺交差点' },
  { no:375, from:'広島県呉市・広交差点', to:'島根県大田市・和江漁港入口交差点' },
  { no:376, from:'山口県山口市・仁保入口交差点', to:'山口県岩国市・西長野' },
  { no:377, from:'徳島県鳴門市・鳴門IC入口交差点', to:'香川県観音寺市・姫浜交差点' },
  { no:378, from:'愛媛県伊予市・伊予警察署前交差点', to:'愛媛県宇和島市・御殿内橋東交差点' },
  { no:379, from:'愛媛県松山市・市役所前交差点', to:'愛媛県喜多郡内子町・内子交差点' },
  { no:380, from:'愛媛県八幡浜市・江戸岡交差点', to:'愛媛県上浮穴郡久万高原町・落合交差点' },
  { no:381, from:'高知県須崎市・下分甲交差点', to:'愛媛県宇和島市・栄町港交差点' },
  { no:382, from:'長崎県対馬市・比田勝港', to:'佐賀県唐津市・瀬田原交差点' },
  { no:383, from:'長崎県平戸市・平戸市志々伎町', to:'佐賀県伊万里市・二里大橋交差点' },
  { no:384, from:'長崎県五島市・富江町', to:'長崎県佐世保市・戸尾町交差点' },
  { no:385, from:'福岡県柳川市・蓮蒲池交差点', to:'福岡県福岡市博多区・東光2丁目交差点' },
  { no:386, from:'大分県日田市・小ヶ瀬交差点', to:'福岡県筑紫野市・原田交差点' },
  { no:387, from:'大分県宇佐市・法鏡寺交差点', to:'熊本県熊本市北区・山室交差点' },
  { no:388, from:'大分県佐伯市・佐伯駅前交差点', to:'熊本県球磨郡湯前町・中里交差点' },
  { no:389, from:'福岡県大牟田市・有明町交差点', to:'鹿児島県阿久根市・多田交差点' },
  { no:390, from:'沖縄県石垣市・730交差点', to:'沖縄県那覇市・旭橋交差点' },
  { no:391, from:'北海道釧路市・幣舞ロータリー', to:'北海道網走市・南4条西1丁目交差点' },
  { no:392, from:'北海道釧路市・大楽毛交差点', to:'北海道中川郡本別町・南4丁目交差点' },
  { no:393, from:'北海道小樽市・奥沢十字街交差点', to:'北海道虻田郡倶知安町・北4条東10丁目交差点' },
  { no:394, from:'青森県むつ市・横迎町交差点', to:'青森県弘前市・運動公園入口交差点' },
  { no:395, from:'岩手県久慈市・久慈IC交差点', to:'岩手県二戸市・沖交差点' },
  { no:396, from:'岩手県遠野市・日影橋交差点', to:'岩手県盛岡市・南大橋交差点' },
  { no:397, from:'岩手県大船渡市・権現堂交差点', to:'秋田県横手市・佐賀会交差点' },
  { no:398, from:'宮城県石巻市・大街道新橋西詰', to:'秋田県由利本荘市・水林交差点' },
  { no:399, from:'福島県いわき市・六十枚入口交差点', to:'山形県南陽市・梨郷交差点' },
  { no:400, from:'茨城県水戸市・中央郵便局前交差点', to:'福島県耶麻郡西会津町・黒沢入口交差点' },
  { no:401, from:'福島県会津若松市・北柳原交差点', to:'群馬県沼田市・下川田町交差点' },
  { no:402, from:'新潟県柏崎市・柳橋町交差点', to:'新潟県新潟市中央区・本町交差点' },
  { no:403, from:'新潟県新潟市中央区・栗ノ木橋交差点', to:'長野県松本市・渚1丁目交差点' },
  { no:404, from:'新潟県長岡市・美沢3丁目交差点', to:'新潟県上越市・三ツ屋交差点' },
  { no:405, from:'群馬県吾妻郡中之条町・荷付場交差点', to:'新潟県上越市・鴨島交差点' },
  { no:406, from:'長野県大町市・大黒町交差点', to:'群馬県高崎市・君が代橋西交差点' },
  { no:407, from:'群馬県足利市・南大町交差点', to:'埼玉県入間市・河原町交差点' },
  { no:408, from:'千葉県成田市・寺台交差点', to:'栃木県塩谷郡高根沢町・宝積寺交差点' },
  { no:409, from:'神奈川県川崎市高津区・溝口交差点', to:'千葉県成田市・並木交差点' },
  { no:410, from:'千葉県館山市・南総文化ホール前交差点', to:'千葉県木更津市・長須賀交差点' },
  { no:411, from:'東京都八王子市・左入町交差点', to:'山梨県甲府市・甲府署前交差点' },
  { no:412, from:'神奈川県平塚市・高浜台交差点', to:'神奈川県相模原市緑区・相模湖IC入口交差点' },
  { no:413, from:'山梨県富士吉田市・上宿交差点', to:'神奈川県相模原市緑区・橋本陸橋下交差点' },
  { no:414, from:'静岡県下田市・中島橋交差点', to:'静岡県沼津市・上石田交差点' },
  { no:415, from:'石川県羽咋市・兵庫町交差点', to:'富山県富山市・北馬場交差点' },
  { no:416, from:'福井県福井市・柳原交差点', to:'石川県小松市・東山交差点' },
  { no:417, from:'岐阜県大垣市・河間交差点', to:'福井県南条郡南越前町・桜橋交差点' },
  { no:418, from:'福井県大野市・上菖蒲池交差点', to:'長野県飯田市・明神前交差点' },
  { no:419, from:'岐阜県瑞浪市・陶町大川交差点', to:'愛知県高浜市・衣浦大橋東交差点' },
  { no:420, from:'愛知県豊田市・挙母町1丁目', to:'愛知県豊橋市・西八町交差点' },
  { no:421, from:'三重県桑名市・国道1号交点', to:'滋賀県近江八幡市・友定町交差点' },
  { no:422, from:'滋賀県大津市・瀬田川大橋西詰', to:'三重県松阪市・小津町交差点' },
  { no:423, from:'大阪府大阪市北区・梅新南交差点', to:'京都府亀岡市・加塚交差点' },
  { no:424, from:'和歌山県和歌山市・西汀丁交差点', to:'和歌山県田辺市・芳養松原交差点' },
  { no:425, from:'三重県尾鷲市・坂場交差点', to:'和歌山県御坊市・塩屋交差点' },
  { no:426, from:'兵庫県豊岡市・城崎大橋東詰', to:'京都府福知山市・牧交差点' },
  { no:427, from:'兵庫県明石市・和坂交差点', to:'兵庫県朝来市・大垣交差点' },
  { no:428, from:'兵庫県神戸市中央区・有馬道交差点', to:'兵庫県三木市・中国自動車道吉川IC' },
  { no:429, from:'岡山県倉敷市・唐船交差点', to:'京都府福知山市・新庄交差点' },
  { no:430, from:'岡山県倉敷市・霞橋東詰交差点', to:'岡山県玉野市・宇野駅前交差点' },
  { no:431, from:'島根県出雲市・大島交差点', to:'鳥取県米子市・米子自動車道入口交差点' },
  { no:432, from:'広島県竹原市・竹原市役所南交差点', to:'島根県松江市・相生町交差点' },
  { no:433, from:'広島県大竹市・みどり橋東詰交差点', to:'広島県三次市・巴橋東詰交差点' },
  { no:434, from:'山口県周南市・三田川交差点', to:'広島県三次市・巴橋東詰交差点' },
  { no:435, from:'山口県山口市・吉敷西交差点', to:'山口県下関市・新下関駅付近' },
  { no:436, from:'兵庫県姫路市・末広橋交差点', to:'香川県高松市・中新町交差点' },
  { no:437, from:'愛媛県松山市・市役所前交差点', to:'山口県岩国市・岩国市街' },
  { no:438, from:'徳島県徳島市・徳島本町交差点', to:'香川県坂出市・番の州交差点' },
  { no:439, from:'徳島県徳島市・徳島本町交差点', to:'高知県四万十市・右山交差点' },
  { no:440, from:'愛媛県松山市・市役所前交差点', to:'高知県高岡郡檮原町・新田交差点' },
  { no:441, from:'愛媛県大洲市・大洲駅前交差点', to:'高知県四万十市・中村駅前交差点' },
  { no:442, from:'大分県大分市・府内町1丁目', to:'福岡県大川市・向島交差点' },
  { no:443, from:'福岡県大川市・中原交差点', to:'熊本県氷川町・宮原交差点' },
  { no:444, from:'長崎県大村市・大村市池田地区', to:'佐賀県鹿島市・国道207号交点' },
  { no:445, from:'熊本県熊本市中央区・代継橋交差点', to:'熊本県人吉市・九日町交差点' },
  { no:446, from:'宮崎県日向市・鶴町交差点', to:'熊本県球磨郡湯前町・中里交差点' },
  { no:447, from:'宮崎県えびの市・えびのIC入口交差点', to:'鹿児島県出水市・六月田町交差点' },
  { no:448, from:'鹿児島県指宿市・十二町交差点', to:'宮崎県宮崎市・橘通3丁目交差点' },
  { no:449, from:'沖縄県国頭郡本部町・本部港', to:'沖縄県名護市・城1丁目' },
  { no:450, from:'北海道旭川市・4条通8丁目交差点', to:'北海道紋別市・本町交差点' },
  { no:451, from:'北海道留萌市・元川町交差点', to:'北海道滝川市・新町交差点' },
  { no:452, from:'北海道夕張市・若菜交差点', to:'北海道旭川市・4条通8丁目交差点' },
  { no:453, from:'北海道札幌市中央区・北1条西2丁目', to:'北海道伊達市・梅本町交差点' },
  { no:454, from:'青森県八戸市・塩町交差点', to:'青森県南津軽郡大鰐町・長峰交差点' },
  { no:455, from:'岩手県盛岡市・NHK前交差点', to:'岩手県下閉伊郡岩泉町・岩泉交差点' },
  { no:456, from:'岩手県盛岡市・南大橋交差点', to:'岩手県一関市・大東町' },
  { no:457, from:'岩手県一関市・大町交差点', to:'宮城県白石市・白石市役所前交差点' },
  { no:458, from:'山形県新庄市・五日町交差点', to:'山形県上山市・上山城入口交差点' },
  { no:459, from:'新潟県新潟市中央区・本町交差点', to:'福島県双葉郡浪江町・知命寺交差点' },
  { no:460, from:'新潟県新発田市・新発田駅前交差点', to:'新潟県柏崎市・柳橋町交差点' },
  { no:461, from:'栃木県日光市・神橋交差点', to:'茨城県日立市・国道6号交点' },
  { no:462, from:'長野県佐久市・跡部交差点', to:'群馬県伊勢崎市・赤堀今井町交差点' },
  { no:463, from:'埼玉県越谷市・神明町交差点', to:'埼玉県入間市・河原町交差点' },
  { no:464, from:'千葉県松戸市・松戸隧道交差点', to:'千葉県成田市・寺台交差点' },
  { no:465, from:'千葉県茂原市・茂原交差点', to:'千葉県富津市・浅間山運動公園入口交差点' },
  { no:466, from:'東京都世田谷区・瀬田交差点', to:'神奈川県横浜市神奈川区・青木通交差点' },
  { no:467, from:'神奈川県大和市・深見西交差点', to:'神奈川県藤沢市・藤沢橋交差点' },
  { no:468, from:'神奈川県横浜市金沢区・釜利谷JCT付近', to:'千葉県木更津市・木更津金田IC' },
  { no:469, from:'静岡県御殿場市・ぐみ沢上交差点', to:'山梨県南巨摩郡南部町・内船交差点' },
  { no:470, from:'石川県輪島市・河井中央交差点', to:'富山県砺波市・高道交差点' },
  { no:471, from:'石川県羽咋市・兵庫町交差点', to:'岐阜県高山市・上岡本町交差点' },
  { no:472, from:'富山県射水市・本町交差点', to:'岐阜県郡上市・八幡町稲成交差点' },
  { no:473, from:'愛知県蒲郡市・競艇場西交差点', to:'静岡県牧之原市・波津交差点' },
  { no:474, from:'長野県飯田市・飯田山本IC', to:'静岡県浜松市天竜区・浜松いなさ北IC' },
  { no:475, from:'愛知県豊田市・豊田東JCT', to:'三重県四日市市・四日市北JCT' },
  { no:476, from:'福井県大野市・大野市役所前交差点', to:'福井県敦賀市・岡山町交差点' },
  { no:477, from:'三重県四日市市・四日市橋南詰交差点', to:'大阪府池田市・西本町交差点' },
  { no:478, from:'京都府宮津市・宮津天橋立IC', to:'京都府久世郡久御山町・久御山IC' },
  { no:479, from:'大阪府豊中市・稲津町交差点', to:'大阪府大阪市住之江区・浜口交差点' },
  { no:480, from:'大阪府和泉市・大野町北交差点', to:'和歌山県有田市・初島町浜交差点' },
  { no:481, from:'大阪府泉佐野市・関西国際空港', to:'大阪府泉佐野市・上之郷' },
  { no:482, from:'京都府宮津市・国道178号交点', to:'鳥取県米子市・米子自動車道入口交差点' },
  { no:483, from:'兵庫県豊岡市・但馬空港入口交差点', to:'兵庫県丹波市・春日IC' },
  { no:484, from:'岡山県備前市・伊部東交差点', to:'岡山県高梁市・落合橋交差点' },
  { no:485, from:'島根県隠岐郡隠岐の島町・西町', to:'島根県松江市・相生町交差点' },
  { no:486, from:'岡山県総社市・門前交差点', to:'広島県東広島市・御薗宇交差点' },
  { no:487, from:'広島県呉市・本通1丁目交差点', to:'広島県広島市南区・宇品海岸交差点' },
  { no:488, from:'島根県益田市・須子町交差点', to:'広島県廿日市市・吉和' },
  { no:489, from:'山口県周南市・大神交差点', to:'山口県山口市・阿東徳佐' },
  { no:490, from:'山口県宇部市・松山町1丁目交差点', to:'山口県萩市・木間入口交差点' },
  { no:491, from:'山口県下関市・才川交差点', to:'山口県長門市・新大坊交差点' },
  { no:492, from:'香川県高松市・中新町交差点', to:'高知県長岡郡大豊町・大杉交差点' },
  { no:493, from:'高知県高知市・県庁前交差点', to:'高知県安芸郡東洋町・甲浦交差点' },
  { no:494, from:'愛媛県松山市・市役所前交差点', to:'高知県須崎市・吾桑交差点' },
  { no:495, from:'福岡県北九州市若松区・若松駅前', to:'福岡県福岡市東区・香椎' },
  { no:496, from:'福岡県行橋市・行橋駅前', to:'大分県日田市・南元町交差点' },
  { no:497, from:'福岡県福岡市博多区・千代交差点', to:'佐賀県武雄市・武雄北方IC' },
  { no:498, from:'佐賀県鹿島市・鹿島駅前', to:'長崎県佐世保市・八幡町交差点' },
  { no:499, from:'長崎県長崎市・大波止交差点', to:'鹿児島県阿久根市・阿久根駅前交差点' },
  { no:500, from:'大分県別府市・九州横断道路入口交差点', to:'佐賀県鳥栖市・姫方町交差点' },
  { no:501, from:'福岡県大牟田市・有明町交差点', to:'熊本県宇土市・宇土市境' },
  { no:502, from:'大分県臼杵市・江無田交差点', to:'大分県竹田市・竹田市街' },
  { no:503, from:'熊本県阿蘇郡高森町・高森交差点', to:'宮崎県日向市・鶴町交差点' },
  { no:504, from:'鹿児島県鹿屋市・札元交差点', to:'鹿児島県出水市・六月田町交差点' },
  { no:505, from:'沖縄県国頭郡本部町・本部港', to:'沖縄県名護市・東江交差点' },
  { no:506, from:'沖縄県那覇市・那覇空港', to:'沖縄県中頭郡西原町・西原IC' },
  { no:507, from:'沖縄県糸満市・糸満ロータリー', to:'沖縄県那覇市・古波蔵交差点' },
];
  ...
  const spinRoulette = async () => {
    ...
    const spinInterval = setInterval(() => {
      ...
      if (isManualTurn && !isReviveTurn) {
        ...
        // 国道イベント：スピン中はランダムな国道の起点→終点でアニメーション
        const prefix = isReverse ? '【以外】' : (isMulti ? '【複数】' : '');
        const spinRoad = JAPAN_ROADS[Math.floor(Math.random() * JAPAN_ROADS.length)];
        setDisplayResult({ player: `${prefix}${nameDisp}`, amount: `${spinRoad.from}→${spinRoad.to}` });
  ...
  const finalizeSpin = async (
    ...
    if (roadEventData) {
      ...
      if (effectType === 'heal') {
        ...
        customLogData = { type: logType, message: `🛣️ ${chosenPlayer.name}に${roadLabel}で${roadAmount}ダメージ！`, target: chosenPlayer.name, amount: roadAmount };
      }
